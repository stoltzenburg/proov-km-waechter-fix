...
def test_average_wear_uses_true_division():
    # VOS-4471: 14900/15000 * 100 ≈ 99.33 %
    # VOS-2210: 3400/15000 * 100 ≈ 22.67 %
    # Average ≈ 61.0 % — floor division would give 61, true division gives ~61.0
    result = fleet_summary(SAMPLE)
    assert abs(result["average_wear"] - 61.0) < 0.5
